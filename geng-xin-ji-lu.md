...
* **新增 CUSTOM** 自定义触发器属性类型
  ...
  * JavaScript 用法示例：[**传送门**](shu-xing-jiao-ben/shou-ba-shou-jiao-ni-xie-shu-xing-jiao-ben/update-lei-xing-1.md)<br>
* **新增 CUSTOM** 自定义触发器注册
...
* **新增** **KILLER** 属性处理类型，击杀目标时触发相关处理
  ...
  * JavaScript 用法示例：[**传送门**](kai-fa-wen-dang/api-1.md#javascript-zhong-shi-yong-ji-shu-qi-shi-li)
* **新增** 属性自定义计数器工具
  * 可用于在属性处理中对某些数据进行计数
  * **AttributeData.getCounter()** 获取 **counter** 主控对象
  * 相关方法：[**传送门**](kai-fa-wen-dang/api-1.md)
...
<figure><img src=".gitbook/assets/image (2).png" alt="" width="563"><figcaption><p>图1</p></figcaption></figure>

<figure><img src=".gitbook/assets/image (3).png" alt="" width="563"><figcaption><p>图2 (attributes.yml)</p></figcaption></figure>

<div align="center" data-full-width="false"><figure><img src=".gitbook/assets/图片.png" alt="" width="563"><figcaption><p>图3</p></figcaption></figure></div>
...
<figure><img src=".gitbook/assets/旧.png" alt=""><figcaption><p>旧版本格式</p></figcaption></figure>

<figure><img src=".gitbook/assets/新.png" alt=""><figcaption><p>新版本格式</p></figcaption></figure>
...
* **修复** 属性值加成数值异常，使用 **(%)** 百分比加成格式时 _(3.3.0.8.1)_
* **修复** 属性变量在某种情况下无法读取问题 (包括战斗力变量异常问题) _(3.3.0.8.2)_
* **优化** 实时同步类与加成类属性的处理任务 _(3.3.0.8.1)_
...
* **新增** 自定义条件规则标签
  ...
  * 更多详细内容，请查看相关页面 [自定义条件标签](du-qu-xiang-guan/zi-ding-yi-tiao-jian-biao-qian.md)
...
* **新增** 自定义属性读取格式 (正则匹配)
  ...
  * 详细内容请查看 [新版读取格式相关](du-qu-xiang-guan/xin-du-qu-ge-shi-xiang-guan-3.3.0.7.md) 页面
* **新增** 自定义规则标签读取格式 (正则匹配)
...
配置更新内容请查看 [attribute.yml](cha-jian-pei-zhi/pei-zhi/attribute.yml.md)
