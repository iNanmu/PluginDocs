...
* `阅读` [`CustomTriggerComponent`](../../kai-fa-wen-dang/descriptionlinecondition.md) `组件开发页面`

<pre class="language-javascript"><code class="lang-javascript"><strong>var priority = 1
</strong>var combatPower = 0.0
